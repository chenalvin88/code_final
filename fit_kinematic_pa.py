...
#############################################################################
 ...
 Copyright (C) 2005-2017, Michele Cappellari
...
def fit_kinematic_pa(x, y, vel, debug=False, nsteps=361,
    ...
    if plot:
        ...
        plt.subplot(122)
        plot_velfield(x, y, vel - vSyst, vmin=-mx, vmax=mx,colorbar=True)
...
if __name__ == '__main__':
    ...
    import warnings
    warnings.filterwarnings('ignore')  # Ignore matplotlib DeprecationWarning
